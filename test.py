...
with open('rs19_val/jpgs/rs19_val/rs00004.jpg', "rb") as image_file, open('rs19_val/uint8/objects/91_5.png', "rb") as mask_file:
    ...
    model = torch.load('models/model_10_0.1', map_location=torch.device('cpu'))
